        ...
        <div className="utility">
          <div className="container">
            <div className="ul">
              <h1>{t("terms")}</h1>
              <span>
                {t("home")} <i className="fa fa-chevron-right"></i> {t("terms")}
              </span>
            </div>
          </div>
        </div>
        <div className="container terms">
          <div className="row gx-0 en">
            <aside className="col-xl-3 sidebar sticky-sidebar mt-md-0 py-16 d-none d-xl-block">
              <div className="widget">
                <nav id="sidebar-nav">
                  <ul className="list-unstyled text-reset">
                    <li>
                      <a className="nav-link scroll" href="#TermsOfUse">
                        1. Terms of Use
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#AccessToTheSite">
                        2. Access to the Site
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#UserContent">
                        3. User Content
                      </a>
                    </li>
                    <li>
                      <a
                        ...
                        href="#ThirdPartyLinksAdsOtherUsers"
                      >
                        4. Third-Party Links & Ads; Other Users
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#Disclaimers">
                        5. Disclaimers
                      </a>
                    </li>
                    <li>
                      <a
                        className="nav-link scroll"
                        href="#LimitationOnLiability"
                      >
                        6. Limitation on Liability
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#CopyrightPolicy">
                        7. Copyright Policy
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#General">
                        8. General
                      </a>
                    </li>
                    <li>
                      <a className="nav-link scroll" href="#ContactInformation">
            ...
            <div className="col-xl-8">
              <section id="TermsOfUse" className="wrapper pt-16">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">1. Terms of Use</h2>
                    <p>Version 1.0</p>
                    <p>
                      The Gymme website located at https://gymmeclub.com/ is a
                      copyrighted work belonging to Gymme. Certain features of the
              ...
              <section id="AccessToTheSite" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">2. Access to the Site</h2>
                    <p>
              ...
              <section id="UserContent" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">3. User Content</h2>
                    <p>
                      <strong>User Content.</strong> "User Content" means any and
                      all information and content that a user submits to the Site.
                      You are exclusively responsible for your User Content. You
                      bear all risks associated with use of your User Content. 
                      You hereby certify that your User Content does not violate
                      our Acceptable Use Policy.  You may not represent or imply
                      to others that your User Content is in any way provided,
                      sponsored or endorsed by Company. Because you alone are
                      responsible for your User Content, you may expose yourself
                      to liability. Company is not obliged to backup any User
                      Content that you post; also, your User Content may be
                      deleted at any time without prior notice to you. You are
                      solely responsible for making your own backup copies of your
                    ...
                    <p>
                      ...
                      your User Content in the Site.  You hereby irreversibly
                      waive any claims and assertions of moral rights or
                      attribution with respect to your User Content.
                    </p>
                    <p>
                      <strong>Acceptable Use Policy.</strong> The following terms
                      constitute our "Acceptable Use Policy": You agree not to use
                      the Site to collect, upload, transmit, display, or
                      distribute any User Content (i) that violates any
                      third-party right or any intellectual property or
                    ...
                    <p>
                      ...
                      regarding the Site, you hereby assign to Company all rights
                      in such Feedback and agree that Company shall have the right
                      to use and fully exploit such Feedback and related
                      information in any manner it believes appropriate.  Company
                      will treat any Feedback you provide to Company as
                    ...
                    <p>
                      ...
                      Company reserves the right to assume the exclusive defense
              ...
              <section id="ThirdPartyLinksAdsOtherUsers" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">
                      4. Third-Party Links & Ads; Other Users
              ...
              <section id="Disclaimers" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">5. Disclaimers</h2>
                    <p>
              ...
              <section id="LimitationOnLiability" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">6. Limitation on Liability</h2>
                    <p>
              ...
              <section id="CopyrightPolicy" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">7. Copyright Policy</h2>
                    <p>
              ...
              <section id="General" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">8. General</h2>
                    <p>
                    ...
                    <p>
                      ...
                      sent to: Building 91 - North Louts 2 - First New Cairo.
                      After the Notice is received, you and the Company may
                      attempt to resolve the claim or dispute informally.  If you
                      and the Company do not resolve the claim or dispute within
                      thirty (30) days after the Notice is received, either party
                      may begin an arbitration proceeding.  The amount of any
              ...
              <section id="ContactInformation" className="wrapper py-8">
                <div className="card">
                  <div className="card-body p-10">
                    ...
                    <ul className="icon-list bullet-bg bullet-soft-primary">
                      <li>
                        ...
                        Address: Building 91 - North Louts 2 - First New Cairo
                      </li>
                      <li>
                        <span>
                          <i className="uil uil-check"></i>
