        ...
        <div className="utility">
          <div className="container">
            <div className="ul">
              <h1>{t("Privacy")}</h1>
              <span>
                {t("home")} <i className="fa fa-chevron-right"></i> {t("Privacy")}
              </span>
            </div>
          </div>
        </div>
          ...
          <div className="row gx-0 en">
            ...
            <div className="col-xl-8">
              ...
              <section id="BusinessTransactions" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">11. Business Transactions</h2>
                    <p>
              ...
              <section id="LawEnforcement" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">12. Law enforcement</h2>
                    <p>
              ...
              <section id="OtherLegalRequirements" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">13. Other legal requirements</h2>
                    <p>
              ...
              <section id="SecurityOfYourPersonalData" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">14. Security of Your Personal Data</h2>
                    <p>
              ...
              <section id="ChildrenPrivacy" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">15. Children's Privacy</h2>
                    <p>
              ...
              <section id="LinksToOtherWebsites" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">16. Links to Other Websites</h2>
                    <p>
              ...
              <section id="ChangesToThisPrivacyPolicy" className="wrapper pt-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">17. Changes to this Privacy Policy</h2>
                    <p>
              ...
              <section id="ContactUs" className="wrapper py-8">
                <div className="card">
                  <div className="card-body p-10">
                    <h2 className="mb-3">18. Contact Us</h2>
                    <p>
